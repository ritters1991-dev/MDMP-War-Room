...
export const ROOM_TYPES = {
  ...
  COA1: {
    id: "COA1",
    name: "COA 1 — Concentrated Gap Crossing",
    shortName: "COA 1",
    color: "#4A9EE8",
    icon: "▣",
...
COMMON REQUIREMENTS: Incorporate military deception, explore BN-sized Air Assault, create Division Reconnaissance element.`,
  ...
  COA2: {
    id: "COA2",
    name: "COA 2 — Dispersed Gap Crossing",
    shortName: "COA 2",
    color: "#3EAF5C",
    icon: "◆",
...
COMMON REQUIREMENTS: Incorporate military deception, explore BN-sized Air Assault, create Division Reconnaissance element.`,
  ...
  REDCELL: {
    id: "REDCELL",
    name: "RED CELL — Enemy Perspective",
    shortName: "RED CELL",
    color: "#E05555",
    icon: "◎",
...
export function buildSystemPrompt(role, loadedDocs, roomType, crossRoomContext) {
  ...
  const crossRoomSection = crossRoomContext ? `\n\nCROSS-ROOM AWARENESS (Live intel from COA and RED CELL rooms):\nUse this information to answer the Commander's questions about COA development, red cell analysis, or any cross-cutting issues.\n\n${crossRoomContext}\n` : "";
