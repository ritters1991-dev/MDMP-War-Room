...
======================================================================
  25ID APPROVED MISSION ANALYSIS — HUMAN STAFF PRODUCTS
  CDR-APPROVED. These override any prior virtual staff MA outputs.
  All COA Development (Step 3+) must be built on these products.
======================================================================

APPROVED MISSION STATEMENT:
NLT D+17, 25 ID seizes OBJ BRONCOS and OBJ SEAHAWKS to pass 1 AD across PL FIG and interdict enemy in the Corps' AO.
...
COMMANDER'S INTENT:
Purpose: Enable I Corps' penetration East of PL DATE by establishing maneuver conditions that allow 1AD to assume the main effort without interruption or loss of operational momentum.
Key Tasks: (1) Conduct wet gap crossing at PL BANANA. (2) Seize OBJ BRONCOS and OBJ SEAHAWKS. (3) Establish LANES DENVER and SEATTLE. (4) Conduct FPOL of 1AD. (5) Preserve combat power to prevent culmination prior to transition.
End State — Friendly: 25ID controls decisive terrain East of PL DATE, has enabled 1AD FPOL, and retains combat power to continue operations.
End State — Enemy: Enemy forces West of PL DATE are unable to disrupt maneuver or conduct effective counterattack.
End State — Terrain: Crossing sites and maneuver corridors remain secure and trafficable.
End State — Civil: Civilian movement and infrastructure conditions do not impede maneuver, sustainment, or transition to follow-on operations.
...
APPROVED CCIR:
PIR 1: Will 165 BCG position its Artillery Group and BSVs to observe/engage crossing sites along Pa Sak River (PL BANANA) prior to D+13?
PIR 2: Will 165 BCG establish its Frontal Blocking Zone between PL APPLE and PL BANANA prior to D+12?
PIR 3: Will 165 BCG establish its Frontier Defense Zone and deliberate fortifications west of PL DATE (vic OBJ BRONCOS & SEAHAWKS) prior to D+13?
PIR 4: Will 165 BCG deploy advance CPs and mobile EW platoons within FBZ/FDZ prior to D+13?
PIR 5: Will 165 BCG commit its Depth Defense Group (reserve CA-Bn) to conduct decisive CATK against 25ID bridgeheads D+13-D+17?
PIR 6: Where can 25ID cross the Pa Sak River with internal assets?
FFIR 1: Bridging assets receiving direct fire.
FFIR 2: Crossing sites non-trafficable or degraded below required throughput.
FFIR 3: Commitment of the Division reserve.
FFIR 4: Sustainment routes (MSR/ASR) east of PL BANANA disrupted >1 hour.
FFIR 5: 1AD prepared to execute FPOL as scheduled.
FFIR 6: Any BCT combat power drops below 70%.
EEFI 1: Location of primary and alternate crossing sites.
EEFI 2: Timing of wet gap crossing (H-hour).
EEFI 3: Battle handover line timing.
EEFI 4: C2, Communications, and Sustainment node locations.
EEFI 5: Location of division reserve.
